...
<body>
	...
	<form action="LoginAction_doLoginProcess" class="layui-form" method="post">
	<div style="width: 350px;margin: 0 auto;">
		...
		<!-- 设置表格相关的宽度的问题 -->
			...
			<tr>
				<th>学号</th>
				<td>
					<input value="3130703232" type="text" name="studentid" required  lay-verify="required" placeholder="请输入学号" autocomplete="off" class="layui-input">
				</td>
			</tr>
			<tr>
				<th>密码</th>
		...
		<div class="layui-input-block" style="width: 350px;margin: 0 auto;">
			...
			<a class="layui-btn layui-btn-danger" href="LoginAction_toRegisterPage">去注册</a>			
		</div>
	</form>
	<div style="width: 350px;margin: 0 auto;">
