...
<body>
  <!-- 引入顶部的导航栏的信息 -->
	...
	<form action="LoginAction_toUserLimitPage" method="post">
		<input type="text" name="lablevalue" value="${eein }">&nbsp;&nbsp;&nbsp;<input type="submit" value="查询">
		<input type="radio" name="lable" value="studentid" title="用户学号" checked="checked">用户学号
