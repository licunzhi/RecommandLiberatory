...
<title>个性书籍信息推荐页面</title>
</head>
<body  style="background-color: #e2e2e2">
	<!-- 引入顶部的导航栏的信息 -->
	<s:include value="header.jsp"></s:include>
	
	<div class="layui-btn layui-btn-danger layui-btn-radious">
		<a href="LoginAction_toChangeLable">修改个性标签</a>
	</div>
	
		<div align="left">
		<br><br>
			<c:forEach items="${intbooks }" var="book">
